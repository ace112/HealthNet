How to set up and run application, assuming on a RIT SE Machine:

- Download .zip file from server
- Unzip on local machine
- Open a Command Prompt Window and type "cd DIRECTORY" where directory is the location of your unzipped folder
- Then cd into the HealthNet folder so you can the manage.py file
- run "python manage.py makemigrations"
- run "python manage.py migrate"
- run "python manage.py runserver"
- Your application should now be running on localhost:80, open a internet window and navigate to that address to view the application
